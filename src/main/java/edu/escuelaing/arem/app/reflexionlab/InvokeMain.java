...
public class InvokeMain {
    public static void main(String[] args) throws InvocationTargetException, IllegalArgumentException {
        try {
            Class<?> c = Class.forName(args[0]); //objeto que representa las clases RunTest
